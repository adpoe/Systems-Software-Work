...
{
    // YOUR CODE HERE
    // do your strcmp operation based on the id string
    STUDENT *student1_ptr = data1;
    STUDENT *student2_ptr = data2;
    char *andrewID_1_ptr = student1_ptr->andrewID;
    char *andrewID_2_ptr = student2_ptr->andrewID;

    int compareValue = strcmp((char*)andrewID_1_ptr, (char*)andrewID_2_ptr);
...
void freeStudent(void *student)
{
    ...
    STUDENT *s1_ptr = student;
    free(s1_ptr->andrewID);
    free(s1_ptr->name);
    free(s1_ptr->major);
    free(s1_ptr);
}
